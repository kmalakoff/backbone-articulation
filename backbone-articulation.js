...
(function() {
  ...
  Backbone.Articulation._mixin = function(target_constructor, source_constructor, source_fns) {
    var Link, fn, fns, name, _link_super;
  ...
  Backbone.Articulation.Model = (function(_super) {
    ...
    Model.mixin = function(target_constructor) {
      return Backbone.Articulation._mixin(target_constructor, Backbone.Articulation.Model, ['toJSON', 'parse', 'set', 'unset', 'clear', 'change', '_ownAttribute', '_disownAttribute']);
    };
  ...
  Backbone.Articulation.Collection = (function(_super) {
    ...
    Collection.prototype.model = Backbone.Articulation.Model;
    ...
    Collection.mixin = function(target_constructor) {
      return Backbone.Articulation._mixin(target_constructor, Backbone.Articulation.Collection, ['toJSON', 'parse', '_reset', '_onModelEvent']);
    };
