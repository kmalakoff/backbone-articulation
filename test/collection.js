$(document).ready(function() {
  ...
  test("Model: serialize", function() {
    ...
    ok(CloneDestroy.clone_count===3*(collection.models.length*2), '3 models with three instances in their attributes and previous attributes');
    collection.reset();
    ok(CloneDestroy.clone_count===0, '0 models with zero instances');
  });
  ...
  test("Model: deserialize", function() {
    ...
    ok(CloneDestroy.clone_count===3*2*(collection.models.length+collection2.models.length), '5 models with three instances in their attributes and previous attributes');
