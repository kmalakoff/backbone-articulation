...
_.each(this.models,function(b){Backbone.Relational.store.unregister(b);b.clear({silent:!0})}):_.each(this.models,function(b){b.clear({silent:!0})}));return k.apply(this,arguments)};var l=Backbone.Collection.prototype._onModelEvent;Backbone.Collection.prototype._onModelEvent=function(b,a,c,e){if(b=="destroy"){for(var d in this._previousAttributes)this._disownAttribute(d,this._previousAttributes[d]);for(d in this.attributes)this._disownAttribute(d,this.attributes[d])}return l.apply(this,arguments)};
if(Backbone.RelationalModel)Backbone.RelationalModel.prototype.toJSON=function(){if(this.isLocked())return this.id;this.acquire();var b=Backbone.Model.prototype.toJSON.call(this);_.each(this._relations,function(a){var c=b[a.key];a.options.includeInJSON===!0&&c&&typeof c==="object"?b[a.key]=_.isFunction(c.toJSON)?c.toJSON():c:_.isString(a.options.includeInJSON)?c?c instanceof Backbone.Collection?b[a.key]=c.pluck(a.options.includeInJSON):c instanceof Backbone.Model?b[a.key]=c.get(a.options.includeInJSON):
